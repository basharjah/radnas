...
class Api {
  ...
  /// The keystore, for the one other thing worth keeping there: the saved-accounts list, which
  /// holds live tokens. Kept generic rather than typed here so Api stays the transport and Auth
  /// keeps the model.
